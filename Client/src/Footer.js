      ...
      <div className="footerflexbox">
        <div className="footerleft">
          <div className="footer-profile">
            ...
            <p className="footer-profile-name">Abhijit Sharma</p>
          </div>

          <div className="footericons">
            <a href="https://www.instagram.com/abhijits.10/">
              <img className="footer-icons" src={Insta} />
            </a>
            <a href="https://twitter.com/Abhjit07">
              <img className="footer-icons" src={Twitter} />
            </a>
            <a href="https://www.linkedin.com/in/sharma-abhijit/">
              <img className="footer-icons" src={Linkedin} />
            </a>
            <a href="https://github.com/abhijitsh">
        ...
        <div className="footerright">
          <div className="footer-contact">
            ...
            <p>Contact: +8306580413</p>
          </div>
          <div className="footer-contact">
            <img className="footer-contact-icons" src={Email} />
            <p>Email: abhijitvapi03@gmail.com</p>
          </div>
          <div className="footer-contact">
